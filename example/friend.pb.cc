...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ndListRequest\022\017\n\007user_id\030\001 \001(\r\"P\n\025GetFri"
  "endListResponse\022\"\n\006result\030\001 \001(\0132\022.fixbug"
  ".ResultCode\022\023\n\013friend_list\030\002 \003(\0142`\n\020Frie"
  "ndServiceRpc\022L\n\rGetFriendList\022\034.fixbug.G"
  "etFriendListRequest\032\035.fixbug.GetFriendLi"
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            auto str = _internal_add_friend_list();
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
...
uint8_t* GetFriendListResponse::_InternalSerialize(
  ...
  for (int i = 0, n = this->_internal_friend_list_size(); i < n; i++) {
    const auto& s = this->_internal_friend_list(i);
...
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListResponse)
  ...
  // repeated bytes friend_list = 2;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.friend_list_.size());
  for (int i = 0, n = _impl_.friend_list_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::BytesSize(
      _impl_.friend_list_.Get(i));
  }
