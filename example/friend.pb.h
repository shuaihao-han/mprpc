...
class GetFriendListResponse final :
 ...
 public:
  ...
  // repeated bytes friend_list = 2;
  int friend_list_size() const;
  private:
  int _internal_friend_list_size() const;
  public:
  void clear_friend_list();
  const std::string& friend_list(int index) const;
  std::string* mutable_friend_list(int index);
  void set_friend_list(int index, const std::string& value);
  void set_friend_list(int index, std::string&& value);
  void set_friend_list(int index, const char* value);
  void set_friend_list(int index, const void* value, size_t size);
  std::string* add_friend_list();
  void add_friend_list(const std::string& value);
  void add_friend_list(std::string&& value);
  void add_friend_list(const char* value);
  void add_friend_list(const void* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& friend_list() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_friend_list();
  private:
  const std::string& _internal_friend_list(int index) const;
  std::string* _internal_add_friend_list();
  public:
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> friend_list_;
...
inline std::string* GetFriendListResponse::add_friend_list() {
  std::string* _s = _internal_add_friend_list();
  // @@protoc_insertion_point(field_add_mutable:fixbug.GetFriendListResponse.friend_list)
  return _s;
}
inline const std::string& GetFriendListResponse::_internal_friend_list(int index) const {
  return _impl_.friend_list_.Get(index);
}
inline const std::string& GetFriendListResponse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResponse.friend_list)
  return _internal_friend_list(index);
}
inline std::string* GetFriendListResponse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponse.friend_list)
  return _impl_.friend_list_.Mutable(index);
}
inline void GetFriendListResponse::set_friend_list(int index, const std::string& value) {
  _impl_.friend_list_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListResponse.friend_list)
}
inline void GetFriendListResponse::set_friend_list(int index, std::string&& value) {
  _impl_.friend_list_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListResponse.friend_list)
}
inline void GetFriendListResponse::set_friend_list(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.friend_list_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:fixbug.GetFriendListResponse.friend_list)
}
inline void GetFriendListResponse::set_friend_list(int index, const void* value, size_t size) {
  _impl_.friend_list_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFriendListResponse.friend_list)
}
inline std::string* GetFriendListResponse::_internal_add_friend_list() {
  return _impl_.friend_list_.Add();
}
inline void GetFriendListResponse::add_friend_list(const std::string& value) {
  _impl_.friend_list_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListResponse.friend_list)
}
inline void GetFriendListResponse::add_friend_list(std::string&& value) {
  _impl_.friend_list_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListResponse.friend_list)
}
inline void GetFriendListResponse::add_friend_list(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.friend_list_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:fixbug.GetFriendListResponse.friend_list)
}
inline void GetFriendListResponse::add_friend_list(const void* value, size_t size) {
  _impl_.friend_list_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:fixbug.GetFriendListResponse.friend_list)
}
